...
'use client';
import Logo from "./slices/Logo";
import { useEffect, useState } from 'react';

export default function Navigation() {
    type ElementArray = NodeListOf<Element> | null;
  ...
  return (
    <>
      <div className="nav wrapper grotesk mr-auto w-full flex-nowrap md:flex-wrap mb-16 flex items-center sm:mx-0 sm:mb-20 sm:px-0 md:px-6 bg-slate-900 relative bg-transparent md:pb-24 border-b-2 border-solid md:border-b-0">
        <div className="nav-logo mt-4 pb-4 pl-8 w-full justify-between flex md:border-b-2 md:border-solid">
          <a href="/" className="logo align-middle text-3xl font-bold text-black ">
            <Logo />
          </a>
        ...
        <div className="md:hidden " onClick={openBurger}>
          <button className="navbar-burger flex items-center text-blue-600 p-3">
            <svg className="block h-12 w-8 fill" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <title>Mobile menu</title>
              <path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"></path>
            </svg>
          </button>
        </div>
        <ul className={`lg:hidden ${burger ? 'block' : 'hidden'} absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6`}>
          <li><a className="text-sm text-gray-400 hover:text-gray-500" href="#">Home</a></li>
          <li className="text-gray-300">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-4 h-4 current-fill" viewBox="0 0 24 24">
              <path strokeLinejoin="round" strokeWidth="2" d="M12 5v0m0 7v0m0 7v0m0-13a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z" />
            </svg>
          </li>
        ...
        <div className={`navbar-menu relative z-50 ${burger ? 'block' : 'hidden'}`}>
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            <div className="flex items-center mb-8">
              ...
              <button onClick={closeBurger} className="navbar-close">
